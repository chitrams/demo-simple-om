...
The next few lines after that are the malaria parameters. You can change these around as you wish; I've selected the ones in the current script for a relatively quick run (less than five minutes on the HPC).
